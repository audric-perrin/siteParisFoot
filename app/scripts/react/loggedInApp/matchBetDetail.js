...
var MatchBetDetail = React.createClass({
  ...
  dataMatchBet: function(matchId) {
    ...
    Ajax.request(options, this.handleMatchBet)
  },
  onClose: function() {
    this.props.onClose()
  },
  ...
  renderMatchTitle: function(arrowLeft, arrowRight) {
    ...
    return d.div({
      ...
      d.div({
        ...
        React.createElement(Logo, {name: match.teamDomicile, float: 'right', margin: '10px 10px'})
      ),
      d.div({
        style: {
          color: COLOR.dark,
      ...
      d.div({
        ...
        React.createElement(Logo, {name: match.teamExterieur, float: 'left', margin: '10px 10px'})
      ),
      d.div({
        style: {
          display: 'inline-block',
  ...
  render: function() {
    ...
    if (this.state.isLoading) {
      elements = [
        'Chargement ',
        d.i({key: 'loadingIcon', className: 'fa fa-spinner fa-pulse'})
      ]
    }
    else {
      elements = [
