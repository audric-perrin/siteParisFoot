...
var Box_login = React.createClass({
  ...
  renderSubmit: function() {
    ...
    return d.div({key: 'submit'}, element)
  },
...
module.exports = {
  Box_login: Box_login,
  Box_signup: Box_signup,
  Master_box_input: Master_box_input,
  Box_input_text: Box_input_text,
  Icone: Icone
}
