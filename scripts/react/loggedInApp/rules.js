  ...
  render: function() {
    return d.div({
      ...
      this.renderPuce([
        ...
        'RG : nombre de résultat correct trouvé',
        'PTSR : nombre de point gagné avec un résultat correct',
        'SG : nombre de score trouvé',
        'PTSS : nombre de point gagné avec un score correct',
